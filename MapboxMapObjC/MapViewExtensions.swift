...
@objc
open class MBXCancelable : NSObject {
...
extension MapView {
    ...
    @discardableResult
    @objc public func onMapLoaded(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
        let cancelable = mapboxMap.onNext(event: .mapLoaded) { data in
            // TODO Convert data to obj-c data
            handler(data)
        }
        
        return MBXCancelable(cancelable: cancelable)
    }
    ...
    @discardableResult
    @objc public func onMapLoadingError(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onMapIdle(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onStyleDataLoaded(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onStyleLoaded(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onStyleImageMissing(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onStyleImageRemoveUnused(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onSourceDataLoaded(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onSourceAdded(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onSourceRemoved(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onRenderFrameStarted(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    @discardableResult
    @objc public func onRenderFrameFinished(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    /// so that an updated camera state can be fetched immediately.
    @discardableResult
    @objc public func onEvenCameraChanged(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
    ...
    /// map or snapshotter.
    @discardableResult
    @objc public func onResourceRequest(_ handler: @escaping (AnyObject) -> Void) -> MBXCancelable {
