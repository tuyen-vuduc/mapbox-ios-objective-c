...
extension TMBLineLayer: SwiftValueConvertible {
    ...
    func mapTo(_ dest: inout LineLayer) {
        ...
        dest.lineCap = self.lineCap?.lineCap()
        dest.lineJoin = self.lineJoin?.lineJoin()
        dest.lineMiterLimit = self.lineMiterLimit?.double()
        dest.lineRoundLimit = self.lineRoundLimit?.double()
        ...
        dest.lineDasharray = self.lineDasharray?.arrayOfDouble()
        dest.lineDepthOcclusionFactor = self.lineDepthOcclusionFactor?.double()
        dest.lineDepthOcclusionFactorTransition = self.lineDepthOcclusionFactorTransition?.unwrap()
        dest.lineEmissiveStrength = self.lineEmissiveStrength?.double()
        ...
        dest.lineGradient = self.lineGradient?.styleColor()
        ...
        dest.linePattern = self.linePattern?.resolvedImage()
        dest.lineTranslate = self.lineTranslate?.arrayOfDouble()
        dest.lineTranslateTransition = self.lineTranslateTransition?.unwrap()
        dest.lineTranslateAnchor = self.lineTranslateAnchor?.lineTranslateAnchor()
        dest.lineTrimOffset = self.lineTrimOffset?.arrayOfDouble()
