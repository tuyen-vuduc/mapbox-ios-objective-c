...
@objc open class TMBVectorSource: NSObject, TMBSource {
    @objc public convenience init(id: String) {
        self.init(id, type: TMBSourceType.vector)
    }
...
extension TMBVectorSource {
    public func mapTo(_ source: inout VectorSource) {
...
extension VectorSource {
    public func mapTo(_ source:inout TMBVectorSource) {
...
extension TMBVectorSource: SwiftValueConvertible {
    public func swiftValue() -> VectorSource {
...
extension VectorSource {
    public func objcValue(_ id: String) ->  TMBVectorSource {
        var source = TMBVectorSource(id: id)
