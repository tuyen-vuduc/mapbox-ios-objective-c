...
@objc open class TMBRasterDemSource: NSObject, TMBSource {
    @objc public convenience init(id: String) {
        self.init(id, type: TMBSourceType.rasterDem)
    }
    ...
    @objc public var encoding: NSNumber?
...
extension TMBRasterDemSource {
    public func mapTo(_ source: inout RasterDemSource) {
...
extension RasterDemSource {
    public func mapTo(_ source:inout TMBRasterDemSource) {
        ...
        source.attribution = self.attribution
        source.encoding = self.encoding?.asNumber()
...
extension TMBRasterDemSource: SwiftValueConvertible {
    public func swiftValue() -> RasterDemSource {
...
extension RasterDemSource {
    public func objcValue(_ id: String) ->  TMBRasterDemSource {
        var source = TMBRasterDemSource(id: id)
